...
export default function Reels({ post }: any) {
  console.log(post, "post찎어보자");
  ...
  let currentIndex = Number(localStorage.getItem("reelsIndex"));
  const endIndex = Number(localStorage.getItem("reelslength"));
                                    ...
                                    <div className={styles.bodyHeader}>
                                      ...
                                      >
                                        <div className={styles.profileLink2}>
                                          <div className={styles.profileLink3}>
                                            <div>
                                              <span
